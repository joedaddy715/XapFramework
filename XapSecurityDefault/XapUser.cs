    ...
    internal class XapUser : IXapUser {
        ...
        void IXapUser.Login(string lobName) {
            ...
            try {
                ...
                db = DbFactory.Instance.Db("acts", _currentLob, "SECURITY.RecordUserLogin");
                db.AddParameter(DbFactory.Instance.DbParameter("LobName", _currentLob))
                    .AddParameter(DbFactory.Instance.DbParameter("UserName", _userName))
                    .ExecuteNonQuery();
        ...
        void IXapUser.LogOut() {
            IXapDataProvider db = null;
            try {
                db = DbFactory.Instance.Db("acts", _currentLob, "SECURITY.RecordUserLogout");
                db.AddParameter(DbFactory.Instance.DbParameter("LobName", _currentLob))
                    .AddParameter(DbFactory.Instance.DbParameter("UserName", _userName))
                    .ExecuteNonQuery();
            } catch (Exception ex) {
        ...
        private void LoadUserData() {
            IXapDataProvider db = null;
            try {
                db = DbFactory.Instance.Db("acts", _userName, "SECURITY.SelectUser");

                XapDataReader dr = db.AddParameter(DbFactory.Instance.DbParameter("UserName", _userName)).ExecuteReader();
        ...
        private void LoadUserRoles() {
            IXapDataProvider db = null;
            try {
                db = DbFactory.Instance.Db("acts", _currentLob, "SECURITY.SelectUserRoles");

                XapDataReader dr = db.AddParameter(DbFactory.Instance.DbParameter("UserName", _userName))
                    .AddParameter(DbFactory.Instance.DbParameter("LobName", _currentLob)).ExecuteReader();
        ...
        private void LoadUserLobs() {
            IXapDataProvider db = null;
            try {
                db = DbFactory.Instance.Db("acts", string.Empty, "SECURITY.SelectUserLobs");
